...
public class T1_Registration_Form {
    ...
    public void registrationForm(){
        ...
        WebElement programmingLanguageCheckbox = Driver.getDriver().findElement(By.xpath("//input[@id='inlineCheckbox2']"));
        ...
        WebElement actualSuccessMessage = Driver.getDriver().findElement(By.tagName("p"));
